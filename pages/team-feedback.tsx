...
export default ProtectedRoute(() => {
  ...
  const feedbackReceived = stateContainer.user.feedbackForMe;

  return (
    <Layout page="team-feedback">
      <Root>
        <OptionalRender shouldRender={feedbackReceived.length === 0}>
          <AlertBox>
